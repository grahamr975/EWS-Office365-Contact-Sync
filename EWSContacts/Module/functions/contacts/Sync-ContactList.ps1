...
=======
			Write-Verbose "Deleting Contact: $($Contact.EmailAddresses[[Microsoft.Exchange.WebServices.Data.EmailAddressKey]::EmailAddress1].Address.ToLower())" for $($Mailbox)
...
=======
				Write-Verbose "Updating Contact: $($Contact.WindowsEmailAddress)" for $($Mailbox)
>>>>>>> 90ca29f2a31ed90da98c339121abf2f941333236
				try {
...
=======
			Write-Verbose "Creating Contact: $($Contact.WindowsEmailAddress)" for $($Mailbox)
>>>>>>> 90ca29f2a31ed90da98c339121abf2f941333236
			try {
