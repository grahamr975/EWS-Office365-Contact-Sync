...
function Get-GALContacts {
	...
	process {
		...
		return $GALContacts
			...
			Write-Log -Level "FATAL" -Message "Failed to fetch Global Address List Contacts from Office 365 Directory" -logfile $Global:LogPath -exception $_.Exception.Message
		}
	}
}
...
process {
	...
	return $EmailAddressList
		...
		Write-Log -Level "FATAL" -Message "Failed to fetch user mailbox list from Office 365 directory" -logfile $Global:LogPath -exception $_.Exception.Message
	}
}
}
